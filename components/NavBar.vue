          ...
          isOpen
            ...
            >
                ...
                <li class="relative hidden sm:block">
                    ...
                    >
                        <li><NuxtLink to="/paintless-dent-repair" class="block px-4 py-2 hover:bg-brand-light" @click="closeAll">Paintless Dent Repair</NuxtLink></li>
                        <li><NuxtLink to="/hail-repair"            class="block px-4 py-2 hover:bg-brand-light" @click="closeAll">Hail Repair</NuxtLink></li>
                        <li><NuxtLink to="/detailing"              class="block px-4 py-2 hover:bg-brand-light" @click="closeAll">Detailing</NuxtLink></li>
                        <li><NuxtLink to="/ceramic-coating"        class="block px-4 py-2 hover:bg-brand-light" @click="closeAll">Ceramic Coating</NuxtLink></li>
                        <li class="border-t mx-2 my-1"></li>
<!--                        <li><NuxtLink to="/recent-work"            class="block px-4 py-2 hover:bg-brand-light" @click="closeAll">Recent&nbsp;Work</NuxtLink></li>-->
                    </ul>
                </li>

                <!-- Services + Recent Work in mobile drawer -->
                <li class="sm:hidden flex flex-col items-end space-y-2 w-full">
                    <NuxtLink to="/paintless-dent-repair" class="hover:text-brand-primary" @click="closeAll">Paintless Dent Repair</NuxtLink>
                    <NuxtLink to="/hail-repair"            class="hover:text-brand-primary" @click="closeAll">Hail Repair</NuxtLink>
                    <NuxtLink to="/detailing"              class="hover:text-brand-primary" @click="closeAll">Detailing</NuxtLink>
                    <NuxtLink to="/ceramic-coating"        class="hover:text-brand-primary" @click="closeAll">Ceramic Coating</NuxtLink>
                    <!-- formerly "Mobile Service" anchor; route to contact instead -->
                    <NuxtLink to="/contact"                class="hover:text-brand-primary" @click="closeAll">Mobile Service</NuxtLink>
<!--                    <NuxtLink to="/recent-work"            class="hover:text-brand-primary" @click="closeAll">Recent&nbsp;Work</NuxtLink>-->
                </li>
