<template>
    <main>
        <section class="max-w-5xl mx-auto px-6 py-20">
            <h1 class="text-4xl md:text-5xl font-bold mb-6">About Acadia PDR</h1>

            <p class="mb-4">
                <strong>Acadia PDR</strong> is a locally owned shop in Lakeland, MN focused on
            ...
            <p>
                Need us to come to you for a small dent, or prefer a drop-off at our Lakeland location?
