<template>
    <main class="flex flex-col bg-white">
        ...
        <!-- Why Choose Acadia (value props) -->
        <section class="my-12 md:my-16 max-w-7xl mx-auto w-full px-6">
            <div class="text-center mb-8">
                <h2 class="text-3xl md:text-4xl font-bold">Why Choose Acadia</h2>
        ...
        <section class="my-12 md:my-16 max-w-7xl mx-auto w-full px-6">
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold">About Acadia PDR</h2>
                    <p class="mt-4 text-neutral-700">
                        We provide precision paintless dent repair to Lakeland and the St. Croix Valley.
        ...
        <section class="my-12 md:my-16 max-w-7xl mx-auto w-full px-6">
            <div class="text-center mb-6">
                ...
                <p class="mt-2 text-neutral-600">We serve the East Metro and St. Croix Valley.</p>
            </div>
